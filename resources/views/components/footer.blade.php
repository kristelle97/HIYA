        ...
        <div class="sm:col-span-2">
            ...
            <div class="mt-6 lg:max-w-sm">
                <p class="text-sm text-gray-800">
                    Lebanon is home to amazing and strong women who are at the heart of our society. They move and work in small circles yet, they could be accomplishing much more if surrounded by the right people. There are many networks and NGOs in Lebanon, however none aims at uniting Lebanese women. The key to success is to have a strong network made of people from different backgrounds, with different skills and different goals.
                </p>
            </div>
        </div>
...
{{--                <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-brick">--}}
...
{{--                </a>--}}
    ...
    <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p class="text-sm text-gray-600">
            © Copyright {{now()->format('Y')}} Intami network. All rights reserved.
        </p>
